    ...
    <table class="table">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href="detail_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>" class="btn btn-info btn-sm">Detail</a>
            ...
            <div class="modal-content">
              ...
              <form action="proses_hapus_pembelian.php" method="post">
                <div class="modal-body">
                  ...
                  Apakah anda yakin ingin menghapus data <b><?php echo $d['NamaPelanggan']; ?></b>
                </div>
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
